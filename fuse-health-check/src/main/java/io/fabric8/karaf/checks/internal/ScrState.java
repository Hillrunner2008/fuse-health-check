...
public class ScrState extends AbstractBundleChecker {
        ...
        if (components != null) {
            for (Component component : components) {
                ...
                if (state != Component.STATE_ACTIVE && state != Component.STATE_REGISTERED
                    ...
                    if (ignoreDefaultFailures(bundle)) {
    ...
    //JBOSS FUSE 6.3 ships with many failing scr dependencies in fabric related bundles
    private static boolean ignoreDefaultFailures(Bundle bundle1) {
        return !bundle1.getSymbolicName().startsWith("io.fabric8");
    }
